...
namespace primal::id
{
	...
	{
		const id_type index { id & internal::index_mask };
	...
	namespace internal
	{
		struct id_base
		{
			constexpr explicit id_base(const id_type id) : _id { id } { }
...
#define DEFINE_TYPED_ID(name) struct name final : id::internal::id_base { constexpr explicit name(id::id_type id) : id_base{ id } { } constexpr name() : id_base { 0 } { }	 };
#else
